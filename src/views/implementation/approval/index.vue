<template>
  <div class="approval-container">
    <div class="page-header">
      ...
      <div class="page-desc">管理项目立项相关材料、流程和会议，确保项目顺利立项启动</div>
    </div>
...
// 导入原来的子菜单页面组件
const ApplicantManageComponent = defineAsyncComponent(() => import('@/views/approval/applicant/manage.vue'))
const ApplicantSubmitComponent = defineAsyncComponent(() => import('@/views/approval/applicant/submit.vue'))
const ManagementCenterComponent = defineAsyncComponent(() => import('@/views/approval/management/center.vue'))
const ManagementConclusionComponent = defineAsyncComponent(() => import('@/views/approval/management/conclusion.vue'))
