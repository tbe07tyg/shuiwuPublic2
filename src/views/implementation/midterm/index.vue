<template>
  <div class="midterm-container">
    <div class="page-header">
      ...
      <div class="page-desc">管理项目中期检查相关材料、流程和会议，确保项目按计划推进</div>
    </div>
    ...
    <a-tabs 
      ...
      <a-tab-pane key="application-submit" class="applicant-role">
        <template #tab>
          <FileTextOutlined class="applicant-role-icon" />
          提交中期
        </template>
...
import { UserOutlined, FileTextOutlined, SettingOutlined, TeamOutlined } from '@ant-design/icons-vue'

// 导入原来的子菜单页面组件
const ApplicantManageComponent = defineAsyncComponent(() => import('@/views/midterm/applicant/manage.vue'))
const ApplicantSubmitComponent = defineAsyncComponent(() => import('@/views/midterm/applicant/submit.vue'))
const ManagementCenterComponent = defineAsyncComponent(() => import('@/views/midterm/management/center.vue'))
const ManagementConclusionComponent = defineAsyncComponent(() => import('@/views/midterm/management/conclusion.vue'))
