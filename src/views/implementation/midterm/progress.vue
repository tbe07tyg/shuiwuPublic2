<!--
 * @file 中期进度查询页面 - 申报单位角色
 * @description 申报单位查询中期检查申请的进度和状态
 * @author 科研管理系统
 * @version 3.0.0
 * @date 2025-01-23
-->
<template>
  <div class="midterm-progress-query">
    <!-- 页面头部 -->
      ...
      <a-form layout="inline" :model="queryForm" @finish="handleQuery">
        ...
        <a-form-item label="申请状态" name="status">
          ...
          >
            ...
            <a-select-option value="completed">中期完成</a-select-option>
          </a-select>
        </a-form-item>
    ...
    >
      <div v-if="currentDetail" class="progress-detail">
        ...
        <a-descriptions :column="2" bordered>
          ...
          <a-descriptions-item label="预期中期时间" :span="2">
            {{ currentDetail.expectedMidtermDate }}
          </a-descriptions-item>
        </a-descriptions>
    ...
    timeline: [
      {
        id: 1,
        title: '提交申请',
        description: '中期检查申请已成功提交，材料包括中期报告、进展总结等',
      ...
      },
      {
        id: 3,
        title: '会议安排',
        description: '中期检查会已安排，时间：2024-07-10 14:00',
        time: '2024-06-20 09:15',
        status: 'process'
      }
    ]
  },
    ...
    timeline: [
      {
        id: 1,
        title: '提交申请',
        description: '中期检查申请已成功提交',
        time: '2024-06-18 16:45',
        status: 'finished'
      },
      {
        id: 2,
...
const getProgressText = (status) => {
  const textMap = {
    ...
    'meeting_scheduled': '中期检查会已安排，请按时参加',
    'completed': '中期检查流程已完成'
  }
...
const resubmit = (item) => {
  router.push(`/implementation/midterm/application/submit?id=${item.id}&type=resubmit`)
}
...
const goToSubmit = () => {
  router.push('/implementation/midterm/application/submit')
}
